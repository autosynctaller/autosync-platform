...
"[project]/autosync-platform/src/app/api/auth/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const valid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$autosync$2d$platform$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyPassword"])(password, user.password);
        if (!valid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$autosync$2d$platform$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Email o contraseña incorrectos'
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bb1d555._.js.map